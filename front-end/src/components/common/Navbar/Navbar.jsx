                                    ...
                                    {headerNavLink.map((a, i) => (
                                        <li className='group' key={i}>
                                            <Link href={a.url} legacyBehavior>
                                                <a className='text-base font-sans text-black py-2 mx-8 lg:mx-2 flex group-hover:text-blue-400 transition duration-300 ease-in-out'>{a.title}</a>
                                            </Link>
                                        </li>
                                    ))}
                                    <li className='group'>
                                        <Link href='/auth/login' legacyBehavior>
                                            <a className='text-base text-black py-2 mx-8 lg:mx-2 flex group-hover:text-blue-400 transition duration-300 ease-in-out'>Login</a>
                                        </Link>
                                    </li>
                                    <li className='group'>
                                        <Link href='/auth/register' legacyBehavior>
                                            <a className='text-base text-black py-2 mx-8 lg:mx-2 flex group-hover:text-blue-400 transition duration-300 ease-in-out'>Register</a>
                                        </Link>
                                    </li>
                                </ul>
                            </nav>
