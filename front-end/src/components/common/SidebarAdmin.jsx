...
function Sidebar() {
    ...
    const activeClass =
        'bg-blue-500 rounded text-white text-xs uppercase p-3 mt-2 mb-1 font-bold flex'
    const inActiveClass =
        'text-indigo-500 hover:text-black text-xs uppercase py-3 font-bold flex'
                        ...
                        <ul className="md:flex-col md:min-w-full flex flex-col list-none">
                            ...
                            <li>
                                <Link href="/" legacyBehavior>
                                    <a className="text-indigo-500 hover:text-black text-xs uppercase py-3 font-bold flex">
