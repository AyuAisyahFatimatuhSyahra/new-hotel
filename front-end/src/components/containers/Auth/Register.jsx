                        ...
                        <div className="flex flex-col gap-4 p-4 md:p-8">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 text-gray-800 border focus:ring ring-blue-500  rounded outline-none transition duration-100 px-3 py-2"
                                    required
                                />
                            </div>
                            ...
                            <div>
                                <button type="submit" className="mt-10 flex justify-between items-center bg-blue-500 hover:bg-blue-400 active:bg-blue-600 focus-visible:ring ring-gray-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">Register</button>
                            </div>
                        </div>
                    </form>
                </div>
