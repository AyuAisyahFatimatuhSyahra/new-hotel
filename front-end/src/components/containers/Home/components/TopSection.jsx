        ...
        <section className="max-w-full mx-auto px-4">
            <div className="min-h-min flex justify-center items-center flex-1 shrink-0 bg-gray-100 overflow-hidden shadow-lg relative my-1 py-16 md:py-40 xl:py-72">
                 <img
                    ...
                    loading="lazy"
                    alt="Lobby"
                    className="w-full h-full object-cover rounded-3xl object-center absolute inset-0 opacity-80"
                /> 

                <div className="border-8 border-blue-500 sm:max-w-xl flex flex-col items-center relative p-4">
