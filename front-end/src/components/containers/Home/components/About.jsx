      ...
      <div className="max-w-7xl mx-auto">
        <div className="container">
          <div className="flex flex-wrap items-center justify-center">
            ...
            <div className="mb-10 w-full px-4 lg:w-1/2">
              <p className="font-semibold text-lg xl:text-xl text-blue-500 mb-2">
                Tentang Kami
              </p>
              ...
              <Link href="/" legacyBehavior>
                <a className="inline-block items-center justify-center bg-blue-500 hover:bg-blue-600 active:bg-blue-500 focus-visible:ring ring-blue-500 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-3 py-2">
